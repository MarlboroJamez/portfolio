    ...
    return (
       <div ref={node}>
            ...
            <div style={{'resize':'both','overflow':'auto'}} className="m-3 p-4 border lg:w-110 md:w-96 sm:w-72 border-gray-300 shadow-lg rounded-lg">
                ...
                <a href="https://github.com/MarlboroJamez/PHP-Projects">
                ...
                <h1 className="mt-4 md:mt-0 font-semibold lg:text-3xl md:text-2xl sm:text-xl">🗃️ Custom Eloquent Driver - Laravel</h1>

                <div className="flex mt-8 ml-6">
                    <p className="text-xs mr-1 mt-1">📣</p>
                    <p className="font-base md:text-base text-xs inline-block text-left">The beginning of my Full Stack journey, I had started off with the use of the framework Laravel, by building my own custom Eloquent drivers, that 
                    are supported with Firebase and MySQL, providing a legacy database, since originally Laravel has been built around the use of MySQL only where as Firebase SDK drivers are expired.</p>
                </div>
                ...
                <div className="mt-8 block md:flex">
                    <div>
                        <ul className="w-52 ml-2 md:ml-6">
                            ...
                            <li className="mt-2 m-1 p-1 text-xs rounded-lg font-semibold text-sky-900 opacity-80 bg-sky-100 border border-sky-700">MVC</li>
                            <li className="mt-2 m-1 p-1 text-xs rounded-lg font-semibold text-red-900 opacity-80 bg-red-100 border border-red-700">Eloquent Drivers</li>
                        </ul>
                    </div>

                    <div>
                        <ul className="ml-6 justify-around flex-wrap w-fit flex">
                            <li className="m-1 p-1 text-xs rounded-lg font-semibold text-cyan-900 opacity-80 bg-cyan-100 border border-cyan-700">Laravel</li>
                            <li className="mt-2 m-1 p-1 text-xs rounded-lg font-semibold text-cyan-900 opacity-80 bg-cyan-100 border border-cyan-700">PHP</li>
                            <li className="mt-2 m-1 p-1 text-xs rounded-lg font-semibold text-cyan-900 opacity-80 bg-cyan-100 border border-cyan-700">MySQL</li>
                            ...
                            <li className="mt-2 m-1 p-1 text-xs rounded-lg font-semibold text-cyan-900 opacity-80 bg-cyan-100 border border-cyan-700">Migrations</li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="p-6">
                    <StyleWrapper>
                        <div className="shadow-md shadow-cyan-400 ">
                            <Slider {...settings}>
                                <img className="w-92 h-48 md:w-auto md:h-auto rounded-lg border-gray-300 shadow-lg border-2" src={Laravel} alt="" />
                            </Slider>
                        </div>
                    </StyleWrapper>
                </div>
