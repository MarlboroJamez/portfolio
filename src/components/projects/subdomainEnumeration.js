...
//Projects GIF's
import SubdomainsEnumeration from '../../assets/gif/subdomainenumeration.gif'
    ...
    return (
        <div ref={node}>
            ...
            <div style={{'resize':'both','overflow':'auto'}} className="m-3 p-4 border lg:w-110 md:w-96 sm:w-72 border-gray-300 shadow-lg rounded-lg">
                ...
                <a href="https://github.com/MarlboroJamez/Python-Projects/tree/main/web/subdomain-enumeration">
            ...
            <div style={{'resize':'both','overflow':'auto'}} className="hidden md:block bg-matt-900 p-4 border lg:w-110 md:w-96 sm:w-72 border border-gray-300 shadow-lg rounded-lg">
                <div className="flex">
                ...
                <div class="p-6">
                    <StyleWrapper>
                         <div className="shadow-md shadow-cyan-400 ">
                            <Slider {...settings}>
                                <img className="w-92 h-48 md:w-auto md:h-auto rounded-lg border-gray-300 shadow-lg border-2" src={SubdomainsEnumeration} alt="" />
                            </Slider>
                        </div>
                    </StyleWrapper>
                </div>
