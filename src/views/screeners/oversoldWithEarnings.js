...
function OversoldWithEarnings() {
    ...
    const getData = async () => {
        try {
            setLoading(true)
            const res = await fetch('https://sheet.best/api/sheets/80636766-9a7f-4d22-828a-a46b3dc462a2')
...
export default OversoldWithEarnings
