...
function HighVolumeVolatility() {
    ...
    const getData = async () => {
        try {
            setLoading(true)
            const res = await fetch('https://sheet.best/api/sheets/6ea4b022-a2dc-415a-83ce-049be52836bb')
...
export default HighVolumeVolatility
